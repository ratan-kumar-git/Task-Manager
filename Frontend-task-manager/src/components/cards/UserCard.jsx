    ...
    <div className="user-card p-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src={userInfo?.profileImageUrl || null} alt="avtar" className='w-12 h-12 rounded-full border-2 border-white' />
          <div>
...
const StatCard = ({ label, count, status }) => {
  ...
  return (
    <div className={`flex-1 text-[10px] font-medium ${getStatusTagColor(status)} px-4 py-0.5 rounded`}>
